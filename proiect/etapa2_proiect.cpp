...
public:
    ...
    {
        out<<"Hrana este pentru "<<obj.tip_hrana<<" , se numeste "<<obj.denumire_hrana<<" , cantareste "<<obj.cantitate<<" kg. ";
        return out;
    }
...
//    cout<<a;
    ...
    ///Clasa album,care exemplifica conceptul de HAS A

//    Album x;
//    Animale a(121213,"caine","Husky",40.44,50.55,1,3,'F');
//    x = x + a;/// unde "a" e animal
//    cin>>x;
//    cout<<x;
}
